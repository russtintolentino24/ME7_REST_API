...
public class AlbumController {
    ...
    public @ResponseBody String addAlbum (@RequestBody Albums albums) {
    ...
    public @ResponseBody String updateAlbum (@RequestBody Albums albums) {
        Albums albumToInsert = new Albums();
    ...
    public @ResponseBody String deleteAlbum (@RequestBody Albums albums) {
        albumService.deleteById(albums.getId());
        return "Album Deleted";
    }

    @GetMapping(path="/song")
    public @ResponseBody Collection<AlbumSong> getSongPerAlbum (@RequestParam String album) {
